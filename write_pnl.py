...
def write_pnl_row(service_account_file, client_number, client_name, date_str,
                   transform_result, shipping_cost=0, packaging_cost=0):
    """
    ...
    shipping_cost: carrier cost from Shipments API
    packaging_cost: material cost from packaging_costs.json
    """
