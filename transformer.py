...
ALLREPORTS_HEADERS = [
    ...
    "Storage/Returns", "Shipping cost", "Pick&Pack fee", "Package cost", "Total",
]
...
def transform_bill_details(rows: list[dict], client_name: str = "", client_number: str = "", alert_settings: dict = None) -> dict:
